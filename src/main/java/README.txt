...
SPRINT 3: PATTERNS
Tasca 3: Developers Team (Treball en grup)
Nivells 1, 2 i 3
...
Components del grup:
- https://github.com/eqqbq
- https://github.com/dortegva
- https://github.com/I-Michel
**********************************************************************

Hem de crear un programa per a gestionar el catàleg de productes d'una floristeria.
Utilitza com a persistència MySQL i MongoDB.
